...
Additionally, a limited subset of within-subjects designs are supported. Importantly, the data should have come from a _crossed_, not nested, design. Concretely, this is when an observation about a participant is made for each of the independent variables---not multiple observations within a variable, but a single observation for each level of each independent variable.
